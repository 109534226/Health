...
<body>
    ...
    <div class="container-fluid">
        <div class="form-container">
            <form action="所有使用者資料.php" method="post" enctype="multipart/form-data">
                ...
                <div class="form-row">
                    <label for="useremergencycontact">緊急聯絡人 :</label>
                    <input id="useremergencycontact" type="text" name="useremergencycontact"
                        value="<?php echo $緊急聯絡人; ?>" placeholder="ex:張小華" disabled>
                </div>

                <div class="form-row">
                    <label for="useremergencycontactphone">緊急聯絡人電話 :</label>
                    <input id="useremergencycontactphone" type="tel" name="useremergencycontactphone"
                        value="<?php echo $緊急聯絡人電話; ?>" placeholder="ex:0912345678" disabled>
                </div>
    ...
    <script>
        ...
        function confirmData() {
            ...
            const useremergencycontact = document.getElementById('useremergencycontact').value;
            const useremergencycontactphone = document.getElementById('useremergencycontactphone').value;
            ...
            if (!useremergencycontactphone) {
                alert('緊急連絡人電話欄位不能為空');
                return;
            } else if (!phonePattern.test(useremergencycontactphone)) {
                alert('緊急連絡人電話格式錯誤，台灣手機號碼需為09開頭並有8位數字');
                return;
            } else if (repeatedPattern.test(useremergencycontactphone.slice(2))) {
                alert('緊急連絡人電話格式錯誤，後面8位數字不可出現6位或以上重複的數字');
                return;
            }
            ...
            const confirmMessage =
                ...
                `聯絡電話: ${userphone}\n` +
                `電子郵件: ${useremail}\n` +
                `緊急聯絡人: ${useremergencycontact}\n` +
                `緊急聯絡人電話: ${useremergencycontactphone}\n` +
                `確定要提交資料嗎？`;
